...
go get github.com/slowfei/oss-client@v0.1.0

# Pull one or more provider drivers (each registers itself via init):
go get github.com/slowfei/oss-client/providers/aws@v0.1.0
go get github.com/slowfei/oss-client/providers/minio@v0.1.1
...
| --- | --- | --- |
| `github.com/slowfei/oss-client` | `pkg/uos/v0.1.0` | Unified `Client` API (stdlib-only). |
