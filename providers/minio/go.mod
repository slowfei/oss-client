module github.com/maqian/object-storage-client/providers/minio
...
// runnable here without a network round-trip. Mirrors pkg/testkit/contract's
// own replace toward the root module.
replace (
