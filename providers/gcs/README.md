...
`github.com/maqian/object-storage-client/providers/gcs` — native driver for
**Google Cloud Storage (GCS)** via [`cloud.google.com/go/storage`](https://godoc.org/cloud.google.com/go/storage).

| Field | Value |
| --- | --- |
| Module path | `github.com/maqian/object-storage-client/providers/gcs` |
...
```bash
go get github.com/maqian/object-storage-client/providers/gcs@providers/gcs/v0.1.1
```
...
import (
    ...
    _ "github.com/maqian/object-storage-client/providers/gcs" // registers Factory
)
