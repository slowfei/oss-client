...
`github.com/slowfei/oss-client/providers/alibaba` — native driver for
...
| Field | Value |
| --- | --- |
| Module path | `github.com/slowfei/oss-client/providers/alibaba` |
...
```bash
go get github.com/slowfei/oss-client/providers/alibaba@providers/alibaba/v0.1.1
```
...
import (
    ...
    _ "github.com/slowfei/oss-client/providers/alibaba" // registers Factory
)
