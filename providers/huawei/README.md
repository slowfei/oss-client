...
`github.com/maqian/object-storage-client/providers/huawei` — native driver for
...
| Field | Value |
| --- | --- |
| Module path | `github.com/maqian/object-storage-client/providers/huawei` |
...
```bash
go get github.com/maqian/object-storage-client/providers/huawei@providers/huawei/v0.1.1
```
...
import (
    ...
    _ "github.com/maqian/object-storage-client/providers/huawei" // registers Factory
)
