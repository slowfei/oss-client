...
`github.com/slowfei/oss-client/providers/upyun` — native driver for
...
| Field | Value |
| --- | --- |
| Module path | `github.com/slowfei/oss-client/providers/upyun` |
...
```bash
go get github.com/slowfei/oss-client/providers/upyun@providers/upyun/v0.1.1
```
...
import (
    ...
    _ "github.com/slowfei/oss-client/providers/upyun" // registers Factory
)
